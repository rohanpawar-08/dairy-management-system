...
-- ============================================================================
-- 7. Shift Management Sessions (Migration 004)
-- ============================================================================
CREATE TABLE IF NOT EXISTS shifts (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    business_date TEXT NOT NULL, -- Business date YYYY-MM-DD (Asia/Kolkata)
...
-- Partial unique index ensuring only ONE shift can be OPEN globally across the entire database
...
-- ============================================================================
-- 8. Milk Collection Records (Migration 004 Immutable Transaction Snapshot)
-- ============================================================================
